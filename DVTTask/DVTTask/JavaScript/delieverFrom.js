async function validateForm() {
  ...
  const deliveryAddressValue = document
  ...
  if (
    !Number.isInteger(parseFloat(numProductsValue)) ||
    numProductsValue < 1 ||
    numProductsValue > 100
  ) {
...
function displaySummaryForm(
  ...
  deliveryStatusInfo.textContent =
    "Delivery Status: " + (deliverToUser ? "Yes" : "No");
